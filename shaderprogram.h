...
public:
	...
	GLuint getUniformLocation(const char* variableName); //Pobiera numer slotu związanego z daną zmienną jednorodną
	GLuint getAttribLocation(const char* variableName); //Pobiera numer slotu związanego z danym atrybutem
};
